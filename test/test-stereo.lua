...
iRNorm = normalisation:forward(iR):float()
iLNorm = normalisation:forward(iL):float()

-- calling the stereoC.lua routine

eex.stereo(dispMap, dispMap, iLNorm[1], iRNorm[1], edges, corrWindowSize, dMin, dMax, UpDown, opt.th)
