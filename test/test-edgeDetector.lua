...
-- Asking to the user what to do
io.write("\nHere there are provided two different demos\n")
io.write("  Type 'h' if you want to view the [h]istograms,\n")
io.write("  type 'l' if you want to view the [l]ive demo (h|l): ")
